  ...
  <section className="bg-white dark:bg-gray-900">
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
      <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
        ...
        <h1 className="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">Promo Sampai 55% Pada Bulan Juli, Tunggu Apa Lagi Ayo Pesan Sekarang</h1>
        <p className="text-lg mt-5 font-normal text-gray-500 dark:text-gray-400 mb-6">Segera tekan tombol dibawah untuk melihat promo menarik pada awal bulan!</p>
        <Link to={'/Package'} className="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
          Lihat Paket
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
          ...
          <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Tidak Punya Bingkai Foto yang menarik? Tunggu Apa Lagi Segera Order di Umega Studio!!! Promo sampai tanggal 31 Juli 2023</h2>
          <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Tekan tombol dibawah untuk melihat bingkai menarik....</p>
          <Link to={'/Shop'} className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Lihat Bingkai
        ...
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
          ...
          <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Ingin memberikan umpan balik tentang situs web kami? Kami sangat menghargai setiap saran dan komentar yang Anda berikan.</h2>
          <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Tekan tombol dibawah untuk mengirim pesan</p>
          <Link to={'/Kontak'} className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center"> Kirim Pesan
            <svg aria-hidden="true" className="w-4 h-4 ml-2" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
            </svg>
          </Link>
