    ...
    return (
        ...
        <div className="md:flex md:justify-between">
            ...
            <a href="" className="flex items-center">
                ...
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-grey">Umega Studio</span>
            </a>
            </div>
            ...
            <div>
                ...
                <li className="mb-4">
                    <a href="" className="hover:underline">Umega Studio</a>
                </li>
                <li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="" className="hover:underline">Umega</a>. All Rights Reserved.
            </span>
